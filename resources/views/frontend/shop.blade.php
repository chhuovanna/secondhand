        ...
        {{--<div class="container">--}}
            ...
            {{--<div class="row isotope-grid">--}}
                {{--@foreach ($sellers as $seller)--}}
                    ...
                    {{--<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$director}}" data-seller_id="{{$seller->seller_id}}">--}}
                        {{--<!-- Block2 -->--}}
                        {{--<div class="block2">--}}
                            {{--<div class="block2-pic hov-img0">--}}
                                {{--@if($seller->thumbnail->file_name)--}}
                                    {{--<img src="{{asset($seller->thumbnail->location)}}/{{$seller->thumbnail->file_name}}" alt="IMG-PRODUCT">--}}
                                {{--@else--}}
